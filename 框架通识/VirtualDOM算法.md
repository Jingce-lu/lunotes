...
- [深度剖析：如何实现一个 Virtual DOM 算法](#深度剖析如何实现一个-virtual-dom-算法)
  - [1 前言](#1-前言)
  - [2 对前端应用状态管理的思考](#2-对前端应用状态管理的思考)
  - [3 Virtual DOM算法](#3-virtual-dom算法)
  - [4 算法实现](#4-算法实现)
    - [4.1 步骤一：用JS对象模拟DOM树](#41-步骤一用js对象模拟dom树)
    - [4.2 步骤二：比较两棵虚拟DOM树的差异](#42-步骤二比较两棵虚拟dom树的差异)
      - [4.2.1 深度优先遍历，记录差异](#421-深度优先遍历记录差异)
      - [4.2.2 差异类型](#422-差异类型)
      - [4.2.3 列表对比算法](#423-列表对比算法)
    - [4.3 步骤三：把差异应用到真正的DOM树上](#43-步骤三把差异应用到真正的dom树上)
  - [5 结语](#5-结语)
