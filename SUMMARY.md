...
<!-- 5.面试2 -->
* 面经
  - [移动前端图片压缩上传](面经/移动前端图片压缩上传.md)
  - [闭包造成的内存泄露怎么解决？](面经/闭包造成的内存泄露怎么解决.md)
  - [实现一个未知宽高元素的水平垂直居中](面经/实现一个未知宽高元素的水平垂直居中.md)
  - [Vue关于keep-alive的一些用法以及采坑记录](面经/Vue关于keep-alive的一些用法以及采坑记录.md)
  - [Vue路由获取路由参数](面经/Vue路由获取路由参数.md)
  - [css实现幻灯片播放效果](面经/css实现幻灯片播放效果.md)
  - [rem布局](面经/rem布局.md)
  - [跨域解决方案](面经/跨域解决方案.md)
<!-- 5.软技能 -->
* 软技能
  - [软 1-30](软技能/软-1-30.md)
<!-- 6.JS基础 -->
* JS进阶 know
  - [JS基础](面试/Js基础.md)
