...
- [React高频面2](#react高频面2)
  - [1. 为什么选择使用框架而不是原生?](#1-为什么选择使用框架而不是原生)
  - [2. 虚拟DOM的优劣如何?](#2-虚拟dom的优劣如何)
  - [3. 虚拟DOM实现原理?](#3-虚拟dom实现原理)
  - [4. setState到底是异步还是同步?](#4-setstate到底是异步还是同步)
  - [5. React组件通信如何实现?](#5-react组件通信如何实现)
  - [6. React如何进行组件/逻辑复用?](#6-react如何进行组件逻辑复用)
  - [7. mixin、hoc、render props、react-hooks的优劣如何？](#7-mixinhocrender-propsreact-hooks的优劣如何)
  - [8. 你是如何理解fiber的?](#8-你是如何理解fiber的)
  - [9. 你对 Time Slice的理解?](#9-你对-time-slice的理解)
  - [10. redux的工作流程?](#10-redux的工作流程)
  - [11. react-redux是如何工作的?](#11-react-redux是如何工作的)
  - [12. redux与mobx的区别?](#12-redux与mobx的区别)
  - [13. redux中如何进行异步操作?](#13-redux中如何进行异步操作)
  - [14. redux异步中间件之间的优劣?](#14-redux异步中间件之间的优劣)
...
## 4. setState到底是异步还是同步?
有时表现出异步,有时表现出同步
1. `setState`只在合成事件和钩子函数中是“异步”的，在`原生事件`和`setTimeout` 中都是同步的。
...
![2019101201.png](../resource/assets/面试/2019101201.png)


## 11. react-redux是如何工作的?
...
![2019101202.png](../resource/assets/面试/2019101202.png)
