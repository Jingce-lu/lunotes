...
- [错误处理机制](#错误处理机制)
  ...
  - [原生错误类型](#原生错误类型)
    - [SyntaxError 对象](#SyntaxError-对象)
    - [ReferenceError 对象](#ReferenceError-对象)
    - [RangeError 对象](#RangeError-对象)
    - [TypeError 对象](#TypeError-对象)
    - [URIError 对象](#URIError-对象)
    - [EvalError 对象](#EvalError-对象)
    - [总结](#总结)
  - [自定义错误](#自定义错误)
  - [throw 语句](#throw-语句)
  - [try...catch 结构](#trycatch-结构)
  - [finally 代码块](#finally-代码块)
